...
import { verifyAddress, verifyPermissionMiddleare, verifyTokenMiddleware, verityBodyMiddleare } from "../middlewares";
import { createRealEstateSchema } from "../schemas";
import { ReadRealEstateControler, createRealEstateControler } from "../controller";
